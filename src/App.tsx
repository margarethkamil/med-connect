      ...
      <footer className="bg-gray-800 text-white py-8 mt-12">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div>
              <h3 className="text-lg font-semibold mb-4">MedConnect</h3>
              <p className="text-gray-400 text-sm">
                The easiest way to find and book appointments with qualified doctors in your area.
              </p>
            </div>
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li><a href="#" className="text-gray-400 hover:text-white text-sm">For Doctors</a></li>
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li><a href="#" className="text-gray-400 hover:text-white text-sm">Health Articles</a></li>
            ...
            <div>
              <h4 className="text-md font-medium mb-3">Connect</h4>
